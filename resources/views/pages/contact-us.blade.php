                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-field form-group mb-25">
                                            ...
                                            <input type="text" placeholder="Willie M. Stanley" name="name" id="name" required data-error="Please enter your name">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-field form-group mb-25">
                                            ...
                                            <input type="text" placeholder="support@gmail.com" id="email" name="email" required data-error="Please enter your name">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-field form-group">
                                            <button type="submit" class="main-btn">Send Us Message <i class="far fa-arrow-right"></i></button>
