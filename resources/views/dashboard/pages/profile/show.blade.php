            ...
            <div>
                <div class="d-flex profile-wrapper">
                    ...
                    <div class="flex-shrink-0">
                        <a href="pages-profile-settings" class="btn btn-warning"><i
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="{{ URL::asset('velzon/images/users/avatar-4.jpg') }}"
                                                        alt="" class="img-fluid rounded-circle" />
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('velzon/images/small/img-4.jpg') }}"
                                                    alt="" height="50" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                    <h6 class="text-truncate fs-15">Design your apps in
                                                        your own way</h6>
                                                </a>
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('velzon/images/small/img-5.jpg') }}"
                                                    alt="" height="50" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                    <h6 class="text-truncate fs-15">Smartest
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('velzon/images/small/img-6.jpg') }}"
                                                    alt="" height="50" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                    <h6 class="text-truncate fs-15">How to get creative
                                                        in your work</h6>
                                                </a>
                                                                ...
                                                                <div class="accordion-item border-0">
                                                                    <div class="accordion-header" id="headingFive">
                                                                        <a class="accordion-button p-2 shadow-none"
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <div class="flex-shrink-0">
                                                                                    <img src="{{ URL::asset('velzon/images/users/avatar-7.jpg') }}"
                                                                                        alt=""
                                                                                        class="avatar-xs rounded-circle" />
                                                                                </div>
                                                                                <div class="flex-grow-1 ms-3">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <div class="flex-grow-1 ms-3">
                                                                                    <h6 class="fs-14 mb-1">
                                                                                        Your order is
                                                                                        placed <span
                                                                                            class="badge badge-soft-success align-middle">Completed</span>
                                                                                    </h6>
                                                                            ...
                                                                            <div class="row mt-2">
                                                                                <div class="col-xxl-6">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('velzon/images/small/img-3.jpg') }}"
                                                                                                alt=""
                                                                                        ...
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('velzon/images/small/img-7.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('velzon/images/small/img-9.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="badge badge-soft-warning fs-12">
                                                                        Inprogress</div>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex mt-4">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="badge badge-soft-success fs-12">
                                                                        Completed</div>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex mt-4">
