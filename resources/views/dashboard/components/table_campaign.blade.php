            ...
            <table class="table table-nowrap table-centered align-middle">
                ...
                <tbody>
                            ...
                            <div class="avatar-group flex-nowrap">
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-1.jpg" alt=""
                                            class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-2.jpg" alt=""
                                            class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-3.jpg" alt=""
                                            class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="http://127.0.0.1:8000/velzon/images/users/avatar-2.jpg"
                                class="avatar-xxs rounded-circle me-1" alt="">
                        ...
                        <td>
                            <div class="avatar-group">
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-5.jpg" alt=""
                                            class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-6.jpg" alt=""
                                            class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-group">
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-7.jpg"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="progress flex-grow-1 progress-sm" style="width: 68%;">
                                    <div class="progress-bar bg-primary rounded" role="progressbar"
                                        style="width: 64%" aria-valuenow="64" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="http://127.0.0.1:8000/velzon/images/users/avatar-6.jpg"
                                class="avatar-xxs rounded-circle me-1" alt="">
                        ...
                        <td>
                            <div class="avatar-group">
                                ...
                                <div class="avatar-group-item">
                                    <a href="javascript: void(0);" class="d-inline-block">
                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-4.jpg"
                                            alt="" class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                            </div>
