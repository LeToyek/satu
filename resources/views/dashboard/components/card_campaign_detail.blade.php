                ...
                <div class="sticky-side-div">
                    <div class="card ribbon-box border shadow-none right">
                        <div class="ribbon-two ribbon-two-danger"><span><i class="ri-fire-fill align-bottom"></i>
                                Hot</span></div>
                        <img src="http://127.0.0.1:8000/velzon/images/nft/img-05.jpg" alt=""
                            class="img-fluid rounded">
                        <div class="position-absolute bottom-0 p-3">
                            <div class="position-absolute top-0 end-0 start-0 bottom-0 bg-white opacity-25"></div>
                            <div class="row justify-content-center">
                                <div class="col-3">
                                    <img src="http://127.0.0.1:8000/velzon/images/nft/img-02.jpg" alt=""
                                        class="img-fluid rounded">
                                </div>
                                <div class="col-3">
                                    <img src="http://127.0.0.1:8000/velzon/images/nft/img-03.jpg" alt=""
                                        class="img-fluid rounded">
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <img src="http://127.0.0.1:8000/velzon/images/nft/img-06.jpg" alt=""
                                        class="img-fluid rounded">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="p-2 border border-dashed rounded text-center">
                                <div>
                                    ...
                                    <h5 id="auction-time-1" class="mb-0">314 : 18 : 18 : 25</h5>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="nav-additional-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false" tabindex="-1">Additional Information</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/nft/img-01.jpg"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-1.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/nft/img-03.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <a href="apps-nft-item-details" class="link-dark"><span
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-3.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-5.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/nft/img-06.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <a href="apps-nft-item-details" class="link-dark"><span
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="http://127.0.0.1:8000/velzon/images/users/avatar-8.jpg"
                                                            alt="" class="avatar-xs rounded object-cover">
                                                        <div class="ms-2">
                                                            <a href="#!">
                        ...
                        <div class="row gy-4 gx-0">
                            ...
                            <div class="col-lg-8">
                                <div class="ps-lg-4">
                                    ...
                                    <div class="me-lg-n3 pe-lg-4" data-simplebar="init" style="max-height: 225px;">
                                        <div class="simplebar-wrapper" style="margin: 0px;">
                                                                    ...
                                                                    <div class="border border-dashed rounded p-3">
                                                                        ...
                                                                        <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                            <a href="#" class="d-block">
                                                                                <img src="http://127.0.0.1:8000/velzon/images/small/img-12.jpg"
                                                                                    alt=""
                                                                                    class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="http://127.0.0.1:8000/velzon/images/small/img-11.jpg"
                                                                                    alt=""
                                                                                    class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="http://127.0.0.1:8000/velzon/images/small/img-10.jpg"
                                                                                    alt=""
                                                                                    class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                        </div>
                                            ...
                                            <div class="simplebar-placeholder" style="width: auto; height: 508px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                                            <div class="simplebar-scrollbar"
                                                style="height: 99px; transform: translate3d(0px, 0px, 0px); display: block;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
